...
app.config["SQLALCHEMY_DATABASE_URI"] = "postgresql://localhost/bdpaulHW5"
...
app.config['MAIL_SENDER'] = 'Admin <bdpaul.burner@gmail.com>' # TODO fill in email
app.config['ADMIN'] = os.environ.get('ADMIN') or "Admin <bdpaul.burner@gmail.com>"
...
def send_email(to, subject, template, **kwargs): # kwargs = 'keyword arguments', this syntax means to unpack any keyword arguments into the function in the invocation...
    ...
    thr.start()
    return thr # The thread being returne
#########
